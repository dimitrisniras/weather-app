...
import { WiDaySunny, WiRain, WiCloudy, WiSnow, WiWindDeg } from 'react-icons/wi';
...
export default function Forecast({ data, units }: ForecastProps) {
    ...
    <div className="mt-4">
      ...
      <div className="flex overflow-x-auto">
        {hourlyForecasts.map(item => (
          <div
            key={item.dt}
            className="flex-none w-40 sm:w-48 min-w-[10rem] md:min-w-[12rem] bg-white p-4 rounded-lg shadow-md mr-4 
          ...
          >
            ...
            <div className="flex justify-center items-center mb-2">{getWeatherIcon(item.weather[0].icon)}</div>
